---From https://github.com/brglng/dotfiles/blob/master/config/nvim/lua/brglng/color.lua
...
function M.pack_rgb(r, g, b)
    ...
    local number = bit.bor(bit.lshift(r_byte, 16), bit.lshift(g_byte, 8), b_byte)
